...
### EXP 3.72 Conditional Reliance 2
def generate_textbox_data(n=10000, save=True, save_dir='data', exp_no=3.72, random_bg=False):
    ...
    def create_dataset(n=n):
        ...
        for sw in switch:
            for pa in patch:
                for la in text:
                    if la == -1 and pa == 0: # undecided regions
                        continue
