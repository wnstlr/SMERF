...
### EXP 3.73 Conditional Reliance 3
def generate_textbox_data(n=10000, save=True, save_dir='data', exp_no=3.73, random_bg=False):
    ...
    def create_dataset(n=n):
        ...
        for sw in switch:
            for pa in patch:
                for la in text:
                    if la == -1 and sw == 2: # undecided regions
                        continue
